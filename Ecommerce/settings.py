...
# Ensure Django can find static files from both directories and installed apps
STATICFILES_FINDERS = [
...
EMAIL_BCC = [email.strip() for email in os.getenv('EMAIL_BCC', '').split(',') if email.strip()]
